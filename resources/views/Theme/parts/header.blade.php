...
<div class="main_menu">
    ...
    <div class="container box_1620">
        ...
        <ul class="nav navbar-nav menu_nav justify-content-center">
            <li class="nav-item @yield('home_activation')"><a class="nav-link" href="{{ route('theme.index') }}">Home</a></li>
            <li class="nav-item submenu dropdown  @yield('category_activation')">
            ...
            <li class="nav-item  @yield('contact_activation')"><a class="nav-link " href="{{ route('theme.contact') }}">Contact</a></li>
        </ul>
